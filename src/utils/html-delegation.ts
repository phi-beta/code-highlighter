 ...
 */
export function createDelegatingHtmlTokenizer(
  htmlTokenizer: (code: string) => Token[],
  cssTokenizer?: (code: string) => Token[],
  jsTokenizer?: (code: string) => Token[]
) {
 ...
 */
function findEmbeddedBlocks(code: string): EmbeddedBlock[] {
