...
export class XmlMini extends Lexer {
	...
	public static readonly QUESTION = 11;
	public static readonly XML_COMMENT = 12;
	public static readonly PROCESSING_INSTRUCTION = 13;
	public static readonly XML_DECLARATION = 14;
	public static readonly CDATA_SECTION = 15;
	public static readonly DOCTYPE = 16;
	public static readonly XML_ENTITY = 17;
	public static readonly DOUBLE_QUOTED_STRING = 18;
	public static readonly SINGLE_QUOTED_STRING = 19;
	public static readonly NUMBER = 20;
	public static readonly CLOSING_TAG = 21;
	public static readonly ATTRIBUTE_NAME = 22;
	public static readonly NAMESPACE_PREFIX = 23;
	public static readonly TEXT_CONTENT = 24;
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(XmlMini._LITERAL_NAMES, XmlMini._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(XmlMini._ATN, this);
	}

	// @Override
	public get grammarFileName(): string { return "XmlMini.g4"; }

	// @Override
	public get ruleNames(): string[] { return XmlMini.ruleNames; }

	// @Override
	public get serializedATN(): string { return XmlMini._serializedATN; }

	// @Override
	public get channelNames(): string[] { return XmlMini.channelNames; }

	// @Override
	public get modeNames(): string[] { return XmlMini.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x1C\u010E\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!XmlMini.__ATN) {
			XmlMini.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(XmlMini._serializedATN));
		}
