...
exports.JsonMini = void 0;
const ATNDeserializer_1 = require("antlr4ts/atn/ATNDeserializer");
const Lexer_1 = require("antlr4ts/Lexer");
const LexerATNSimulator_1 = require("antlr4ts/atn/LexerATNSimulator");
const VocabularyImpl_1 = require("antlr4ts/VocabularyImpl");
const Utils = __importStar(require("antlr4ts/misc/Utils"));
class JsonMini extends Lexer_1.Lexer {
    static LCURLY = 1;
    static RCURLY = 2;
    static LBRACK = 3;
    static RBRACK = 4;
    ...
    static VOCABULARY = new VocabularyImpl_1.VocabularyImpl(JsonMini._LITERAL_NAMES, JsonMini._SYMBOLIC_NAMES, []);
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(JsonMini._ATN, this);
    }
    // @Override
    get grammarFileName() { return "JsonMini.g4"; }
    // @Override
    get ruleNames() { return JsonMini.ruleNames; }
    // @Override
    get serializedATN() { return JsonMini._serializedATN; }
    // @Override
    get channelNames() { return JsonMini.channelNames; }
    // @Override
    get modeNames() { return JsonMini.modeNames; }
    static _serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x0E\x89\b\x01" +
    ...
    static get _ATN() {
        if (!JsonMini.__ATN) {
            JsonMini.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(JsonMini._serializedATN));
        }
        return JsonMini.__ATN;
    }
}
exports.JsonMini = JsonMini;
