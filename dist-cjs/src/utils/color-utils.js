...
exports.hexToClosestAnsi = hexToClosestAnsi;
exports.createColorTokenHtml = createColorTokenHtml;
/**
 ...
 */
function createColorTokenHtml(value, baseStyles = []) {
    if (!isHexColor(value)) {
